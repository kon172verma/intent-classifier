...
Usage
-----
    python prepare_lora_data.py --dataset-size 1k
    python prepare_lora_data.py --dataset-size 10k
    python prepare_lora_data.py --dataset-size 1k \\
        --data-dir /path/to/dataset_full --out-dir /path/to/finetune_LoRA/data
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Prepare JSONL splits for LoRA fine-tuning.",
